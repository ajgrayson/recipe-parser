...
describe('recipe parser eng', () => {
  ...
  describe('translates the literal units', () => {
    ...
    it('of "2 1/2-kg bags potatoes"', () => {
      expect(parse('2 1/2-kg bags potatoes', 'eng').unit).to.equal('bag');
    });
    it('of "2 1.2-kg bags potatoes"', () => {
      expect(parse('2 1.2-kg bags potatoes', 'eng').unit).to.equal('bag');
    });
...
//     it('of "qb  di acqua"', () => {
//       expect(parse('qb di acqua', 'ita').unit).to.equal(null);
//       expect(parse('qb di acqua', 'ita').quantity).to.equal(0);

//     });
//     it('of "quanto basta  acqua"', () => {
//       expect(parse('quanto basta di acqua', 'ita').unit).to.equal(null);
//     });
//     it('of "Quanto basta  acqua"', () => {
//       expect(parse('Quanto basta di acqua', 'ita').unit).to.equal(null);
//     });
...
//     });
//     it('of "q.b.   di farina"', () => {
//       expect(parse('di farina', 'ita').ingredient).to.equal('farina');
//     });
//     it('of "q.b.  di farina"', () => {
//       expect(parse('di farina', 'ita').unit).to.equal(null);
//     });
//     it('of "q.b. farina"', () => {
//       expect(parse('farina', 'ita').ingredient).to.equal('farina');
//     });
//     it('of "grammi farina"', () => {
...
//     });
//     it('of "Q.B. di acqua"', () => {
//       expect(parse('Q.B. di acqua', 'ita').unit).to.equal(null);
//     });
//     it('of "acqua quanto basta"', () => {
//       expect(parse('acqua quanto basta', 'ita').unit).to.equal(null);
//     });
...
//     it('"latte"', () => {
//       expect(parse('latte', 'ita').unit).to.equal(null);
//     });
//     it('"farina"', () => {
//       expect(parse('farina', 'ita').unit).to.equal(null);
//     });
//     it('"250 kg di farina"', () => {
